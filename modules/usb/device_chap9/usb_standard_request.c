...
extern const  PROGMEM  S_usb_user_configuration_descriptor usb_user_configuration_descriptor;
...
void usb_generate_remote_wakeup(void)
{
   ...
   {
      (PLLFRQ &= ~ ( (1<<PDIV3)| (1<<PDIV2) | (1<<PDIV1)| (1<<PDIV0)) ,PLLFRQ|= ( (1<<PDIV3)| (0<<PDIV2) | (1<<PDIV1)| (0<<PDIV0)) | (1<<PLLUSB) , PLLCSR = ( ( 0<<PINDIV ) | (1<<PLLE))) ;
