...
void init_adc(void);
const  PROGMEM  U16 temperature_code[]={ 0x3B4,0x3B0,0x3AB,0x3A6,0x3A0,0x39A,0x394,0x38E,0x388,0x381,0x37A,0x373,
...
U16 Get_adc_mic_val(void)
{
   ( ( (ADMUX &= ~((1<<MUX4)|(1<<MUX3)|(1<<MUX2)|(1<<MUX1)|(1<<MUX0)), ADCSRB &= ~(1<<MUX5) ) , ADMUX |= (0x21 & ((1<<MUX4)|(1<<MUX3)|(1<<MUX2)|(1<<MUX1)|(1<<MUX0)) ), ADCSRB |= (0x21 >>5)<<MUX5 ) , (ADCSRA |= (1<<ADSC) ) ) ;
...
U16 Get_adc_temp_val(void)
{
   ( ( (ADMUX &= ~((1<<MUX4)|(1<<MUX3)|(1<<MUX2)|(1<<MUX1)|(1<<MUX0)), ADCSRB &= ~(1<<MUX5) ) , ADMUX |= (0x00 & ((1<<MUX4)|(1<<MUX3)|(1<<MUX2)|(1<<MUX1)|(1<<MUX0)) ), ADCSRB |= (0x00 >>5)<<MUX5 ) , (ADCSRA |= (1<<ADSC) ) ) ;
   while (! ((ADCSRA & (1<<ADIF)) ? (1==1) : (0==1) ) );
   return (U16)(ADCL+((U16)(ADCH<<8)));
}
