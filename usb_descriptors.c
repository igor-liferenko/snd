...
const PROGMEM S_usb_user_configuration_descriptor usb_conf_desc = {
  {sizeof (S_usb_configuration_descriptor)
   , 0x02, (sizeof (S_usb_user_configuration_descriptor))
   , 3, 1, 0, (0x80 | 0x00)
   , 50}
  ,

  {sizeof (S_usb_interface_descriptor)
   , 0x04, 0, 0, 0, 0x01, 0x01, 0x00, 0}
  ,
  ...
  {sizeof (S_usb_ac_interface_descriptor)
   ...
   (sizeof (S_usb_ac_interface_descriptor) +
    ...
    sizeof (S_usb_out_ter_descriptor) + sizeof (S_usb_in_ter_descriptor) +
  ...
  {sizeof (S_usb_in_ter_descriptor)
   , 0x24, 0x02, 0x01, (0x0101)
   , 0x00, 0x01, 0x0000, 0x00, 0x00}
  ,

  {sizeof (S_usb_feature_unit_descriptor_speaker)
   , 0x24, 0x06, 0x02, 0x01, 0x01, (0x01 | 0x02)
   , 0x00}
  ,

  {sizeof (S_usb_out_ter_descriptor)
   , 0x24, 0x03, 0x03, (0x0301)
   , 0x00, 0x02, 0x00}
  ,

  {sizeof (S_usb_in_ter_descriptor)
   , 0x24, 0x02, 0x04, (0x0201)
   , 0x00, 0x01, 0x0000, 0x00, 0x00}
  ,

  {sizeof (S_usb_feature_unit_descriptor_micro)
   , 0x24, 0x06, 0x05, 0x04, 0x01, (0x01 | 0x02)
   , 0x00}
  ,

  {sizeof (S_usb_out_ter_descriptor)
   , 0x24, 0x03, 0x06, (0x0101)
   , 0x00, 0x05, 0x00}
  ,

  {sizeof (S_usb_interface_descriptor)
   , 0x04, 0x01, 0x00, 0x00, 0x01, 0x02, 0x00, 0x00}
  ,
  ...
  {sizeof (S_usb_as_interface_descriptor)
   , 0x24, 0x01, 0x01, 0x01, (0x0001)
   }
  ,
  {sizeof (S_usb_format_type)
   , 0x24, 0x02, 0x01, 0x01, 0x02, 0x10, 0x01, (0x7D00)
   , 0x00}
  ,
  ...
  {sizeof (S_usb_endpoint_audio_specific)
   , 0x25, 0x01, 0x00, 0x00, (0x0000)
   }
  ,

  {sizeof (S_usb_interface_descriptor)
   , 0x04, 0x02, 0x00, 0x00, 0x01, 0x02, 0x00, 0x00}
  ,

  {sizeof (S_usb_interface_descriptor)
   , 0x04, 0x02, 0x01, 0x01, 0x01, 0x02, 0x00, 0x00}
  ,

  {sizeof (S_usb_as_interface_descriptor)
   , 0x24, 0x01, 0x06, 0x01, (0x0001)
   }
  ,
  {sizeof (S_usb_format_type)
   , 0x24, 0x02, 0x01, 0x01, 0x02, 0x10, 0x01, (0x1F40)
   , 0x00}
  ,
  {sizeof (S_usb_endpoint_audio_descriptor)
   , 0x05, (2 | 0x80)
...
const PROGMEM S_usb_manufacturer_string_descriptor
  usb_user_manufacturer_string_descriptor = {
...
const PROGMEM S_usb_product_string_descriptor
  usb_user_product_string_descriptor = {
  sizeof (usb_user_product_string_descriptor)
  , 0x03, {((U16) ('A')), ((U16) ('V')), ((U16) ('R')), ((U16) (' ')),
             ((U16) ('U')), ((U16) ('S')), ((U16) ('B')), ((U16) (' ')),
             ((U16) ('A')), ((U16) ('U')), ((U16) ('D')), ((U16) ('I')),
             ((U16) ('O')), ((U16) (' ')), ((U16) ('D')), ((U16) ('E')),
             ((U16) ('M')), ((U16) ('O'))}
};
